...
/*
Here's where the custom Google Map gets generated for the website.
...
function initializeMap() {
  ...
  // map variable is appended to #mapDiv in resumeBuilder.js so that the map is displayed.
  ...
  */
  function createMapMarker(placeData) {
    ...
    google.maps.event.addListener(marker, 'click', function() {
      // Place code here that you want to trigger upon click of the marker
    });
